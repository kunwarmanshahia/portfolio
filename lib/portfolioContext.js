...
const PORTFOLIO_PAGES = [
  ...
  { file: 'JudgeByTheCover.tsx', label: 'Judge By The Cover' },
...
- Projects: Triunity Martial Arts (client branding), Signatures for Sound (client branding), Clover X Barbershop (client branding), La Haine (print design), The Broken Yolk (layout design), Judge By The Cover (print design).`);
