...
const Home: React.FC = () => {
  const caseStudies = [
    { id: '1', title: 'Case Study One', category: 'Identity', image: 'https://picsum.photos/800/1000?random=1' },
    { id: '2', title: 'Case Study Two', category: 'Photography', image: 'https://picsum.photos/800/1000?random=2' },
