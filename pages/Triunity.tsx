...
const Triunity: React.FC = () => {
  return (
    <div className="px-4 md:px-8 lg:px-12 pt-4 md:pt-6 pb-4 md:pb-6 max-w-[1920px] mx-auto w-full">
      <Link
        to="/"
        className="inline-flex items-center gap-2 text-sm font-sans font-medium text-brand-dark/60 dark:text-brand-light/60 hover:text-orange-500 dark:hover:text-orange-400 transition-colors mb-8"
      >
        ← Back
      </Link>
      ...
      {/* Logo 1 + Logo 2 side by side */}
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4 md:gap-6 mb-8 md:mb-12">
        <div className="bg-black overflow-hidden">
          <img src="/images/triunity-1.png" alt="Triunity Martial Arts – Logo 1" className="w-full h-full object-contain" />
        </div>
        <div className="bg-black overflow-hidden">
      ...
      {/* Logo 4 */}
      <div className="bg-black overflow-hidden">
        <img src="/images/triunity-4.png" alt="Triunity Martial Arts – Logo 4" className="w-full h-full object-contain" />
      </div>
    </div>
  );
};
